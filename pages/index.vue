...
export default {
  ...
  methods: {
    async getMovies(){
      const data = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=9a7ea58eb05cd632ba00838a83188619&language=en-US&page=1')
    ...
    async searchMovies(){
      const data = axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=9a7ea58eb05cd632ba00838a83188619&language=en-US&page=1&query=${this.searchInput}`
      )
      const result = await data
      // console.log(result.data)
      result.data.results.forEach((movie) => {
